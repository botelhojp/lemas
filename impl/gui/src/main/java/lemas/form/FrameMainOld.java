...
public class FrameMainOld extends javax.swing.JFrame {

    private static FrameMainOld instance = new FrameMainOld();

    /**
     * Creates new form FrameCronos
     */
    private FrameMainOld() {        
    ...
    public static FrameMainOld getInstance() {
        return instance;
    }
...
//		}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameMainOld.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new FrameMainOld().setVisible(true);
            }
        });
    }
